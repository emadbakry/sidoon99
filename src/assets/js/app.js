...
class App extends AppHelpers {
	...
	initiateMobileMenu() {
		...
		// make mobile menu active on desktop too
		let navbarhomepage;
if(salla.url.is_page('index')) {
navbarhomepage = "10024"
} else { navbarhomepage = "1024"
};


		menu = new MobileMenu(menu, "(max-width: "+ navbarhomepage + "px)", "( slidingSubmenus: false)");
		salla.lang.onLoaded(() => {
